    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="mt-3 text-2xl font-bold text-white">เข้าสู่ระบบ</h1>
          <p className="mt-1 text-slate-400 text-sm">ยินดีต้อนรับกลับมา!</p>
        </div>
        ...
        <div className="bg-game-card border border-game-border rounded-2xl p-6">
          ...
          <div className="relative mb-5">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-game-card px-3 text-slate-500">หรือใช้อีเมล</span>
            </div>
          </div>
        ...
        <p className="mt-6 text-center text-sm text-slate-500">
          ยังไม่มีบัญชี?{' '}
          <Link href="/auth/signup" className="text-violet-400 hover:text-violet-300 font-semibold">สมัครฟรี</Link>
        </p>
      </div>
    </div>
  )
